...
export default function HomePage() {
    ...
    const fetchLogo = async () => {
        ...
        if (error) {
            createAlert('error', "Error fetching CS logo from storage: " + error.message)
        } else {
    ...
    const fetchYitaoAvatar = async () => {
        ...
        if (error) {
            createAlert('error', "Error fetching Yitao's avatar from storage: " + error.message)
        } else {
    ...
    const fetchJHAvatar = async () => {
        ...
        if (error) {
            createAlert('error', "Error fetching JH's avatar from storage: " + error.message)
        } else {
